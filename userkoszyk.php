    ...
    <main>
        <section>
            ...
            if($_SESSION['A1'] == 1){
                ...
                if(isset($A1)){
                    $_SESSION["BuyedA1".$_SESSION['login']] = true;
                    unset($_SESSION["A1"]);
                }
            ...
            if($_SESSION['A2'] == 1){
                ...
                if(isset($A2)){
                    $_SESSION["BuyedA2".$_SESSION['login']] = true;
                    unset($_SESSION["A2"]);
                }
            ...
            if($_SESSION['B'] == 1){
                ...
                if(isset($B)){
                    $_SESSION["BuyedB".$_SESSION['login']] = true;
                    unset($_SESSION["B"]);
                    }
            ...
            if($_SESSION['C'] == 1){
                ...
                if(isset($C)){
                    $_SESSION["BuyedC".$_SESSION['login']] = true;
                    unset($_SESSION["C"]);
                    }
            ...
            if($_SESSION['D'] == 1){
                ...
                if(isset($D)){
                    $_SESSION["BuyedD".$_SESSION['login']] = true;
                    unset($_SESSION["D"]);
                    }
            ...
            if($_SESSION['E'] == 1){
                ...
                if(isset($E)){
                    $_SESSION["BuyedE".$_SESSION['login']] = true;
                    unset($_SESSION["E"]);
                    }
            ...
            if($_SESSION['All'] == 1){
                ...
                if(isset($All)){
                    $_SESSION["BuyedAll".$_SESSION['login']] = true;
                    unset($_SESSION["All"]);
                    }
            ...
            if($_SESSION['Egz'] == 1){
                ...
                if(isset($Egz)){
                    $_SESSION["BuyedEgz".$_SESSION['login']] = true;
                    unset($_SESSION["Egz"]);
                    }
